    ...
    <div>
      ...
      <section className="mt-8">
        ...
        <div className="mt-3 flex items-center gap-3">
          <button
            onClick={toggle}
            className="flex items-center gap-2 rounded-lg border border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 px-4 py-2 text-sm font-medium text-gray-700 dark:text-neutral-300 transition hover:bg-gray-50 dark:hover:bg-neutral-800"
          >
            {theme === "dark" ? (
