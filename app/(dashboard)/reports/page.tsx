...
export default async function ReportsPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-gray-500">AI-generated trend reports from your data</p>
        ...
        {result.rows.length === 0 ? (
          ...
          result.rows.map((report) => (
            <Link
              ...
              className="block rounded-lg border border-gray-200 bg-white p-5 transition hover:border-indigo-300 hover:shadow-sm"
            >
