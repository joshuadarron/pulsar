      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-gray-900 px-4 py-3 font-medium text-white transition hover:bg-gray-800"
          >
