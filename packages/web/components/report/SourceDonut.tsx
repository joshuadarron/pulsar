...
import type { SourceDistribution } from "@pulsar/shared/types";
...
export default function SourceDonut({ data }: { data: SourceDistribution[] }) {
  ...
  return (
    <div className="rounded-lg border border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 p-5">
      <h3 className="mb-4 text-sm font-semibold text-gray-700 dark:text-neutral-300 uppercase">Source Distribution</h3>
